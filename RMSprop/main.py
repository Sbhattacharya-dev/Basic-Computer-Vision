...
data_distribution(train_labels)
...
class MLP(nn.Module):
    def __init__(self, num_of_neurons_in_hidden_layer=256, num_of_classes=10):
        ...
        self.hidden_layer1 = nn.Linear(num_of_neurons_in_hidden_layer, num_of_neurons_in_hidden_layer)
        self.hidden_layer2 = nn.Linear(num_of_neurons_in_hidden_layer, num_of_neurons_in_hidden_layer)
